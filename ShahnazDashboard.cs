...
{
    public partial class ShahnazDashboard : Form
    {
        ...
        private void BtnShowServiceShahnaz_Click(object sender, EventArgs e)
        {
            string query =
                   ...
                   new SqlConnection(ConnectionString))
            {
                ...
                gridViewShahnazStore.DataSource =
                    table;
            }
        }
        ...
        {
            if (gridViewShahnazStore.CurrentRow == null)
            {
                MessageBox.Show(
        ...
        private void btnBookSerial_Click(object sender, EventArgs e)
        {
                   ...
                   new SqlConnection(ConnectionString))
            {
                ...
                try
                {
                    ...
                    {
                        string detailQuery = @"
                            INSERT INTO BookingDetailsShahnaz
                            (bookingId, serviceId)
