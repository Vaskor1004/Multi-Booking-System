...
namespace Multi_Booking_System
{
    public partial class RoxyHomeService : Form
    {
        ...
        public RoxyHomeService()
        {
            ...
            selectedWorkers.Columns.Add("workerId", typeof(int));
            selectedWorkers.Columns.Add("workerName", typeof(string));
            selectedWorkers.Columns.Add("phone", typeof(string));
            selectedWorkers.Columns.Add("status", typeof(string));
