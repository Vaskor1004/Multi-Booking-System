...
{
    public partial class ShahnazHomeService : Form
    {
        ...
        {
            ShahnazDashboard dashboard = new ShahnazDashboard();
            dashboard.Show();
            this.Hide();
        }
        ...
        private void gridViewAvailableWorkers_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (WorkerId == 1)
            {
                ShahnaazStoreEsha shahnazStoreEsha = new ShahnaazStoreEsha();
                shahnazStoreEsha.Show();
            }
            else if (WorkerId == 2)
            {
               ShahnazStoreEma shahnazStoreEma = new ShahnazStoreEma();
               shahnazStoreEma.Show();
            }
            else if (WorkerId == 3)
            {
               ShahnazStoreShetu shahnazStoreShetu = new ShahnazStoreShetu();
               shahnazStoreShetu.Show();
            }
        }
