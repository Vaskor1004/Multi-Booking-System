...
namespace Multi_Booking_System
{
    public partial class TirthoDashboard : Form
    {
       ...
       /* private void btnAddService_Click(
            object sender,
            EventArgs e)
        {
       ...
       /* private void btnBookSerial_Click(
            object sender,
            EventArgs e)
        {
        ...
        private void gridViewSelectedServices_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
