...
namespace Multi_Booking_System
{
    public partial class ShahriarDashboard : Form
    {
        ...
        public ShahriarDashboard()
        {
            ...
            gridviewSelctedServices.DataSource =
                selectedServices;
        }
        ...
        private void guna2Button1Shahriar_Click(object sender, EventArgs e)
        {
            string query =
               "SELECT * FROM ShahriarStore";
                   ...
                   new SqlConnection(ConnectionString))
            {
                ...
                DataTable table =
                    new DataTable();
                adapter.Fill(table);
                gridviewShahriarService.DataSource = table;
            }
        }
        private void btnStoreAddService_Click(object sender, EventArgs e)
        {
            if (gridviewShahriarService.CurrentRow == null)
            {
                MessageBox.Show(
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
                   ...
                   new SqlConnection(ConnectionString))
            {
                ...
                try
                {
                    ...
                    {
                        string detailQuery = @"
                            INSERT INTO BookingDetailsShahriar
                            (bookingId, serviceId)
        ...
        private void gridviewSelctedServices_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        {
            if (gridviewSelctedServices.CurrentRow == null)
            {
            ...
            {
                int rowIndex =
                    gridviewSelctedServices.CurrentRow.Index;
