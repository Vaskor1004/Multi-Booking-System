...
{
    public partial class RoxyDashBoard : Form
    {
        ...
        private void BtnShowServiceRoxy_Click(object sender, EventArgs e)
        {
            string query =
        ...
        {
            if (gridViewRoxyStore.CurrentRow == null)
            {
                MessageBox.Show(
        ...
        private void btnBookSerial_Click(object sender, EventArgs e)
        {
                   ...
                   new SqlConnection(ConnectionString))
            {
                ...
                try
                {
                    ...
                    {
                        string detailQuery = @"
                            INSERT INTO BookingDetailsRoxy
                            (bookingId, serviceId)
        ...
        {
            RoxyHomeService roxyHomeService = new RoxyHomeService();
            roxyHomeService.Show();
            this.Hide();
        }
    }
}
